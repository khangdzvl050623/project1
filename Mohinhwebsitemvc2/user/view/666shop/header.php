...
// Kiểm tra nếu không có session 'user', chuyển hướng đến trang đăng nhập
if (!isset($_SESSION['user'])) {
    header("Location: ../../user/web/index2.php");
    exit;
}
...
// Kiểm tra nếu có session 'role' và 'role' không phải là 0, chuyển hướng đến trang user.php
...
$isLoggedIn = isset($_SESSION['user']); // True if user is logged in
?>
